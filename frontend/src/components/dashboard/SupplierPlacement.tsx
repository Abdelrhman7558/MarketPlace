...
import {
    ...
    Info, Check, ArrowRight, ShieldCheck
} from 'lucide-react';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="space-y-6">
                    ...
                    <div className="pt-8 space-y-6">
                        ...
                        <select
                            className="w-full h-14 rounded-2xl border border-border/50 bg-surface px-6 text-lg focus:ring-2 focus:ring-primary/20 outline-none transition-all"
                            value={selectedProduct}
                            onChange={(e) => setSelectedProduct(e.target.value)}
                        >
                            <option value="">Choose a product from inventory...</option>
                            <option value="1">Coca Cola Classic 330ml</option>
                            <option value="2">Monster Energy 500ml</option>
                            <option value="3">Red Bull Sugar Free</option>
                        </select>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-muted/50 border border-border/50 rounded-[3rem] p-8 aspect-square flex flex-col items-center justify-center relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-40 h-40 bg-primary/5 rounded-full blur-3xl animate-pulse-slow" />
