            ...
            <div className={`flex flex-col ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'} items-center`}>
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12 space-y-4">
                    ...
                    >
                        ...
                        <Link 
                            href={ctaHref}
                            className="inline-flex items-center gap-2 bg-primary text-[#131921] px-6 py-3 rounded-md font-bold text-xs uppercase tracking-widest hover:bg-primary/90 transition-all active:scale-95"
                        >
                            {ctaText}
                            <ArrowRight size={16} />
                        </Link>
