        ...
        <div className="bg-card px-2">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                placeholder="Min"
                                className="w-full h-10 bg-transparent border border-border/80 rounded-md pl-6 pr-3 text-sm focus:border-primary outline-none transition-colors"
                            />
                        </div>
            ...
            <FilterSection title="Special Offers" defaultOpen={false}>
                <label className="flex items-center gap-2 cursor-pointer group">
                    ...
                    <span className="text-sm text-muted-foreground group-hover:text-primary transition-colors">Discounted Items</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer group mt-2">
                    <input type="checkbox" className="w-4 h-4 rounded-sm border-border text-primary cursor-pointer accent-primary" />
                    <span className="text-sm text-muted-foreground group-hover:text-primary transition-colors">Bulk Save Config</span>
                </label>
            </FilterSection>
        </div>
    );
