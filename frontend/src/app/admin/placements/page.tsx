                    ...
                    return (
                        <div key={slot.id} className="bg-white dark:bg-[#131921] border border-[#DDD] dark:border-white/10 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <div className={cn("p-4 bg-gradient-to-r text-white relative", typeColors[slot.type])}>
                                ...
                                {/* Status badge */}
                                <div className={cn("absolute top-2 right-12 px-2 py-0.5 rounded text-[8px] font-black uppercase tracking-widest", slot.isOpen ? "bg-emerald-400 text-emerald-900" : "bg-red-400 text-red-900")}>
                                    ...
                                    {editingPrice === slot.id ? (
                                        <div className="flex items-center gap-1">
                                            <input
                                                ...
                                                className="w-20 h-7 text-xs border border-[#E77600] rounded px-2 outline-none text-right bg-white dark:bg-[#0F1111] text-[#0F1111] dark:text-white"
                                                autoFocus
                                            />
                                        ...
                                        <div className="space-y-2 border border-dashed border-[#DDD] dark:border-white/10 rounded p-3 bg-white dark:bg-[#0F1111]">
                                            ...
                                            {adForm.image && (
                                                <div className="relative inline-block">
                                                    ...
                                                    <button onClick={() => setAdForm(f => ({ ...f, image: '' }))} className="absolute -top-1 -right-1 w-4 h-4 bg-[#C40000] text-white rounded-full flex items-center justify-center text-[8px]"><X size={8} /></button>
                                                </div>
                                            )}
