        ...
        <div className="max-w-7xl mx-auto space-y-10 p-4 md:p-8 pt-24 min-h-screen bg-[#F5F7F7] dark:bg-[#0A0D12]">
            ...
            <div className="bg-white dark:bg-[#131921] rounded-3xl border border-black/5 dark:border-white/5 p-8 space-y-8 layered-3d-shadow">
                ...
                <div className="relative pt-12 pb-4 px-4">
                    ...
                    <div className="absolute top-1/2 start-8 end-8 h-1 bg-[#E6E6E6] dark:bg-white/5 -translate-y-1/2 rounded-full" />
                    <div className="absolute top-1/2 start-8 w-1/2 h-1 bg-primary -translate-y-1/2 rounded-full shadow-[0_0_10px_rgba(255,107,0,0.4)]" />
                    ...
                    {isLoading ? (
                        ...
                        products.slice(4, 8).map((product, i) => (
                            <div key={product.id} className="group relative">
                                ...
                                <div className="absolute top-2 start-2 bg-white/90 backdrop-blur-md px-2 py-1 rounded-lg border border-black/5 flex items-center gap-1.5 shadow-sm transform -rotate-1 group-hover:rotate-0 transition-transform">
