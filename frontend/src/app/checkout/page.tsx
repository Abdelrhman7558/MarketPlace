        ...
        try {
            ...
            const res = await fetch((process.env.NEXT_PUBLIC_API_URL || 'http://127.0.0.1:3001') + '/orders', {
                ...
                body: JSON.stringify({
                    ...
                    total: total + (selectedShipping?.cost || 0),
                                ...
                                {step === 1 && (
                                    ...
                                    >
                                        ...
                                        <div className="pt-6 border-t border-border/50">
                                            <h3 className="text-lg font-bold mb-6">Delivery Address</h3>
                            ...
                            <div className="bg-card border border-border/50 p-10 rounded-[40px] premium-shadow space-y-10">
                                ...
                                <div className="space-y-5 text-sm">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-accent font-heading font-black">-{formatPrice(total * 0.05, false)}</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                    ...
                                    <div className="pt-8 border-t border-border flex justify-between items-end">
                                        <div className="space-y-1">
                                            ...
                                            <p className="font-heading font-black text-3xl text-primary">{formatPrice((total * 0.95) + (selectedShipping?.cost || 0), false)}</p>
                                        </div>
                                    </div>
                                </div>
