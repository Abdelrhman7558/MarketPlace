            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {Object.entries(SLOT_PRICES).map(([slot, price]) => (
                    <div key={slot} className="bg-[#131921] border border-white/5 p-6 rounded-2xl space-y-2">
                        ...
                        <p className="text-2xl font-black text-white">${price}<span className="text-xs text-white/20 font-medium ml-2">per week</span></p>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-white/20">
                                    ...
                                    <th className="px-8 py-4 text-[10px] font-black text-white/40 uppercase tracking-widest text-right">Requested</th>
                                </tr>
                            </thead>
